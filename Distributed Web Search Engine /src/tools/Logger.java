...
public class Logger {
  ...
  protected void write(int level, String line, Throwable t) {
    ...
    if (level == WARN)
    	logFilePrefix = logFilePrefix + "WARN: ";
    else if (level == ERROR)
    	logFilePrefix = logFilePrefix + "ERROR: ";
    else if (level == FATAL)
    	logFilePrefix = logFilePrefix + "FATAL: ";
    else if (level == INFO)
    	logFilePrefix = logFilePrefix + "INFO: ";
    else if (level == DEBUG)
    	logFilePrefix = logFilePrefix + "DEBUG: ";
  ...
  public static Logger getLogger(Class c) {
    if (prefixToLogger == null) {
      ...
      logfile = null;
    	...
    	// Use calendar year (yyyy) and ISO-like timestamp for clarity
